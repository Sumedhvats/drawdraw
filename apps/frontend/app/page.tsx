  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#13111C] to-[#0F0A1D] text-white">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-8 pt-16 pb-28 relative">
        <div
          className={`opacity-0 transition-opacity duration-1000 ${isLoaded ? "opacity-100" : ""}`}
        >
          ...
          <p className="text-gray-300 text-lg md:text-xl max-w-2xl mb-10">
            The simplest way to visualize your ideas. DrawDraw is a free,
            collaborative online whiteboard built for teams and classrooms.
          </p>
        ...
        <div
          className={`mt-16 glass-card rounded-xl overflow-hidden shadow-[0_0_30px_rgba(147,51,234,0.15)] transition-all duration-1000 transform ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
        >
          <div className="relative">
            <div className="absolute top-0 left-0 right-0 h-12 bg-[#1E1B2C] flex items-center p-3 gap-2">
              ...
              <div className="ml-4 bg-[#14121B] rounded px-20 py-1 text-xs text-gray-500 text-center">
                vats-drawdraw.netlify.app
              </div>
            </div>
            <div className="pt-12">
              <div className="bg-[#14121B] p-8 flex items-center justify-center min-h-[300px] md:min-h-[400px]">
                <div className="draw-svg w-full max-w-2xl">
                  ...
                  >
                    <path
                      style={
                        { "--animation-order": "0" } as React.CSSProperties
                      }
                      d="M100,100 L200,50 L300,150 L400,100 L500,150"
                      stroke="#3B82F6"
                      strokeWidth="3"
                      strokeLinecap="round"
                    />
                    <path
                      style={
                        { "--animation-order": "1" } as React.CSSProperties
                      }
                      d="M100,150 C150,100 200,200 250,150 S350,50 400,100"
                      stroke="#A78BFA"
                      strokeWidth="3"
                      strokeLinecap="round"
                    />
                    <path
                      style={
                        { "--animation-order": "2" } as React.CSSProperties
                      }
                      d="M150,200 L250,200 L250,250 L150,250 Z"
                      stroke="#EC4899"
                      strokeWidth="3"
                      strokeLinecap="round"
                    />
                    <path
                      style={
                        { "--animation-order": "3" } as React.CSSProperties
                      }
                      d="M400,200 L450,250 L350,250"
                      stroke="#F59E0B"
                      strokeWidth="3"
                      strokeLinecap="round"
                    />
                    <circle
                      style={
                        { "--animation-order": "4" } as React.CSSProperties
                      }
                      cx="500"
                      cy="225"
                      r="30"
      ...
      <section id="features" className="py-24 bg-[#0A0A16] relative">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <p className="text-gray-400 text-center max-w-2xl mx-auto mb-16">
            DrawDraw combines simplicity with powerful features to make
            visualization effortless
          </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="flex flex-col items-center text-center">
                <div className="text-5xl font-bold text-blue-500 opacity-50 mb-4">
                  {item.step}
                </div>
      ...
      <section className="relative py-24 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 md:px-8 text-center">
          ...
          <p className="text-gray-300 text-lg md:text-xl max-w-2xl mx-auto mb-10">
            Join thousands of teams and individuals who use DrawDraw for
            brainstorming, teaching, planning, and creating.
          </p>
